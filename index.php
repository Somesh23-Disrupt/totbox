      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-6 col-xl-2">
            <h1 class="mb-0 site-logo"><a href="index.php" class="h2 mb-0"><img src="images/logo.png" alt="logo" width="50%"><span class="text-primary"></span> </a></h1>
          </div>
            ...
            <nav class="site-navigation position-relative text-right" role="navigation">
              ...
              <ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
                ...
                <li class="has-children">
                  <!-- <a href="#about-section" class="nav-link">About us</a></li> -->
        ...
        <div class="row">
          <div class="col-md-7 align-self-center text-center text-md-left">
            <div class="intro-text">
              <h1>We Care For <span class="d-md-block">Your Dreams</span></h1>
              <p class="mb-4">We sculpt ourselves to gift the dreams that your child is aiming for! Our mantra is to provide the best in class education that helps an individual to<span class="d-block"> Learn, Solve, and Evolve from the rest.</p>
            </div>
          </div>
          <div class="col-md-5 align-self-end text-center text-md-right">
            <!-- <img src="images/4.jpg" alt="Image" > -->
            <img src="images/totbox.png" alt="Image">
      ...
      <div class="container">
        <div class="row justify-content-center" data-aos="fade-up">
          <div class="col-lg-6 text-center heading-section mb-5">
            ...
            <h2 class="text-black mb-2">Welcome to TOTBOX!</h2>
            <p>We believe in thinking outside the box from the traditional way of education is crucial nowadays. So here is a platform that can act as a complete guide for your educational career. All you need to do is to Learn the concepts based on the curriculum. Solve the gaps that you feel difficult by getting equipped with the actual kits that can support the concepts. All you need to do is to think outside the box to build the prototypes and there you are standing right out from the crowd.</p>
          </div>
        </div>
          ...
          <div class="col-12">
            <div class="row">
              ...
              <div class="col-lg-5 mr-auto text-lg-right align-self-center order-lg-1" data-aos="fade-left">
                <h2 class="text-black">What’s in the Box?</h2>
                <p class="mb-4"><ul class="list-unstyled ul-book primary mb-0">
              <li>Magazines</li>
              <li>Experiment Kit</li>
              <li>Activity Sheets</li>
              <li>Assembly Manuals</li>
              <li>Stationaries</li>
              <li>QR code to unlock the user profile</li>
            </ul>
            </p>
          ...
          <div class="col-12">
            <div class="row">
              ...
              <div class="col-lg-5 ml-auto align-self-center"  data-aos="fade-right">
                <h2 class="text-black">Why TOTBOX?</h2>
                <p class="mb-4">We design concepts based on the cognitive ability of the students. Providing extended support to the students is our goal not just handing over the product and closing the deal. We strongly believe in nurturing the student from all perspectives of education. We open opportunities for a student to enroll in different fields of interest through multiple portals. We make a student analyze his/her innate skills through highly efficient performance analysis algorithms. To be more precise, we handhold and walk along with the students to take the untravelled path.</p>
                <p><a href="#" class="btn btn-primary">Read More</a></p>
              </div>
            </div>
          </div>
        ...
        <div class="row hover-1-wrap">
          <div class="col-12">
            <div class="row">
              ...
              <div class="col-lg-5 mr-auto text-lg-right align-self-center order-lg-1" data-aos="fade-left">
                <h2 class="text-black">Why Activity Box?</h2>
                <p class="mb-4">In an evolution of the digital era, students from various educational backgrounds find it difficult when it comes to a hands-on experience. Our aim is to provide outstanding digital content that helps them to understand complicated concepts but, we strongly recommend them to try the customized kits that can nurture the concepts in-depth in the minds of the individual. Based on the indirect psychometric process, this can put them in a position to relate the concepts with the real-time objectives.</p>
                <p><a href="#" class="btn btn-primary">Read More</a></p>
              </div>
            </div>
          </div>
      ...
      <div class="container">
        <div class="row justify-content-center" data-aos="fade-up">
          <div class="col-lg-5 align-self-center mr-auto text-left heading-section mb-5">
            ...
            <p class="lead">We are a team of intellectuals who are working hard to build a revolution in the field of education. We are a team of intellectuals who are working hard to build a revolution in the field of education. We define algorithms for individuals specifically based on their psychometric results. Based on complete research and survey, we feel every individual on this planet possesses a strong innate skill better than others. We push ourselves to expose that innate skill that is hidden right beneath the minds of the individual. </p>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-9">
            <div class="row">
              ...
              <div class="col-md-3">
                <center><h2 class="footer-heading mb-4">Follow Us</h2>
                <a href="#" class="pl-0 pr-3"><span class="icon-facebook"></span></a>
                <a href="#" class="pl-3 pr-3"><span class="icon-twitter"></span></a>
                <a href="#" class="pl-3 pr-3"><span class="icon-instagram"></span></a>
                <a href="#" class="pl-3 pr-3"><span class="icon-linkedin"></span></a></center>
              </div>
            </div>
          </div>
          <div class="col-md-3">
        ...
        <div class="row pt-5 mt-5 text-center">
          <div class="col-md-12">
            ...
            <!-- Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved |TOTBOX  <i class="icon-heart text-danger" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank" >#Tech4LYF</a> -->
