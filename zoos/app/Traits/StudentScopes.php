...
trait StudentScopes{
    ...
    public function textReplace($student, $text)
    {
        ...
        $text = str_replace('{{reg_date}}', Carbon::parse($student->reg_date)->format('d M, Y'), $text);
        ...
        $text = str_replace('{{date_of_birth}}', Carbon::parse($student->date_of_birth)->format('d M, Y'), $text);
