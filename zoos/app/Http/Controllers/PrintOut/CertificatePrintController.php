...
class CertificatePrintController extends CollegeBaseController
{
    ...
    public function bonafideCertificate(Request $request, $id)
    {
        ...
        $data['student'] = Student::select('students.id','students.reg_no', 'students.reg_date', 'students.first_name', 'students.middle_name',
            'students.last_name', 'students.date_of_birth', 'students.gender',  'pd.father_first_name', 'pd.father_middle_name',
            'pd.father_last_name', 'pd.mother_first_name', 'pd.mother_middle_name', 'pd.mother_last_name',
            'ai.address', 'ai.state', 'ai.country', 'students.student_image')
        ...
        return view(parent::loadDataToView($this->view_path.'.bonafide'), compact('data'));
    }
