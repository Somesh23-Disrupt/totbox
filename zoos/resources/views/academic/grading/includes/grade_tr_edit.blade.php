<tr class="option_value">
    ...
    <td>
        {!! Form::number('percentage_from[]', $grade_scale->percentage_from, ['class' => 'form-control', 'required']) !!}
    </td>
    <td>
        {!! Form::number('percentage_to[]', $grade_scale->percentage_to, ['class' => 'form-control', 'required']) !!}
    </td>
    <td>
