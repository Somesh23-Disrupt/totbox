<div class="row">
    <div class="col-md-02 align-right">
    ...
    <div class="col-md-10">
        <div class="text-left">
            <h6 class="no-margin-top" style="font-family: 'Times New Roman', cursive; font-size: 14px">
                {{isset($generalSetting->salogan)?$generalSetting->salogan:""}}
            </h6>
            <h2 class="no-margin-top" style="font-family: 'Times New Roman', cursive; font-size: 30px">
                <strong>{{isset($generalSetting->institute)?$generalSetting->institute:""}}</strong>
            </h2>
            <h5 class="no-margin-top" style="font-family: 'Times New Roman', cursive; font-size: 18px">
                {{isset($generalSetting->address)?$generalSetting->address:""}}
            </h5>
            <h5 class="no-margin-top" style="font-family: 'Times New Roman', cursive; font-size: 16px">
