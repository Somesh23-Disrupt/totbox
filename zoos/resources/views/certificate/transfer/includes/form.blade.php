<div class="form-group">
    ...
    <div class="col-sm-2">
        {!! Form::text('date_of_issue', null, ["data-date-format" => "yyyy-mm-dd", "class" => "form-control date-picker border-form input-mask-date"]) !!}
    ...
    <div class="col-sm-2">
        {!! Form::text('date_of_leaving', null, ["data-date-format" => "yyyy-mm-dd", "class" => "form-control date-picker border-form input-mask-date"]) !!}
