        ...
        <div class="main-content-inner">
            <div class="page-content">
                ...
                <div class="page-header">
                    <h1>
                        @include($view_path.'.assignment.includes.breadcrumb-primary')
                        <small>
                ...
                <div class="row">
                    @include('user-staff.assignment.includes.buttons')
                    <div class="col-xs-12 ">
                        @include('includes.flash_messages')
                        @include($view_path.'.assignment.includes.search_form')
                        <!-- PAGE CONTENT BEGINS -->
