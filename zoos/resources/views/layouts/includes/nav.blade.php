        ...
        <div class="navbar-header pull-left">
            <a href="{{ route('home') }}" class="navbar-brand">
                <small class="text-capitalize">
                    ...
                    <strong class="text-capitalize orange2"> |ZOOS </strong>
                    @else
                        TOTBOX
                    @endif
                </small>
            ...
            <button class="pull-right navbar-toggle navbar-toggle-img collapsed" type="button" data-toggle="collapse" data-target=".navbar-buttons,.navbar-menu">
                ...
                @if(isset(auth()->user()->profile_image))
                            <img class="nav-user-photo" src="{{ asset('images/user/'.auth()->user()->profile_image) }}" alt="" />
                            {{--<img class="nav-user-photo" src="{{ asset('assets/images/avatars/admin.png') }}" alt="" />--}}
                        @else
                            <img class="nav-user-photo" src="{{ asset('assets/images/avatars/admin.png') }}" alt="" />
                        @endif
            ...
            <ul class="nav ace-nav">
                <li class="light-blue dropdown-modal user-min">
                    ...
                    <ul class="user-menu dropdown-menu-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
                        @if(isset(auth()->user()->profile_image))
                            <li>
                                <img class="profile-picture" src="{{ asset('assets/images/avatars/admin.png/'.auth()->user()->profile_image) }}" alt="" />
                            </li>
                        @endif
                        <li>
            ...
            <ul class="nav navbar-nav">
                    <li>
                        ...
                        <ul class="dropdown-menu dropdown-light-blue dropdown-caret">
                            ...
                            <li><a href="{{ route('setting.payment-gateway') }}"><i class="fa fa-dollar fa fa-cogs bigger-110 blue"></i>&nbsp;Payment Gateway</a></li>
                        </ul>
                    </li>
            </ul>
        </nav>
