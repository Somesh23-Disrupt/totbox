<div id="sidebar" class="sidebar h-sidebar navbar-collapse collapse ace-save-state hidden-print">
    ...
    <ul class="nav nav-list">
        ...
        <li class="hover">
            <a href="#" class="dropdown-toggle">
                <i class="menu-icon fa fa-book" aria-hidden="true"></i>
                <span class="menu-text"> Research & Development </span>
                <b class="arrow fa fa-angle-down"></b>
            </a>
     ...
     @endability        
        ...
        {{-- Placement BETA --}}
        @ability('super-admin','placement-center')
        <li class="{!! request()->is('')?'active':'' !!} hover">
            <a href="#" class="dropdown-toggle">
                <i class="menu-icon  fa fa-graduation-cap" aria-hidden="true"></i>
                <span class="menu-text"> Placement BETA </span>
...
@endability
            <!--Laboratory-->
        {{-- Laboratory --}}
        @ability('super-admin','research')
        <li class="{!! request()->is('research*')?'active':'' !!} hover">
            <a href="#" class="dropdown-toggle">
                <i class="menu-icon fa fa-book" aria-hidden="true"></i>
            ...
            <b class="arrow"></b> 
            <ul class="submenu">
                        <li class="{!! request()->is('research/member*')?'active':'' !!} hover">
                            <a href="{{ route('research.manage') }}" accesskey="L">
                                <i class="menu-icon fa fa-caret-right"></i>
                                Manage Chemicals
        ...
        @ability('super-admin','resdev')
        <li class="{!! request()->is('resdev*')?'active':'' !!} hover">
            <a href="#" class="dropdown-toggle">
                <i class="menu-icon fa fa-book" aria-hidden="true"></i>
                <span class="menu-text"> R & D </span>
