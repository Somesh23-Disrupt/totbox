        ...
        <div class="row">
            <div class="col-sm-10 col-sm-offset-1">
                <div class="login-container">
                    <div class="center" style="margin-top: 30%;">
                        <h1>
                            ...
                            @else
                                ...
                                @else
                                    <span class="red">TOTBOX | </span>
                                    <span class="white" id="id-text2">ZOOS</span>
                                @endif
                            @endif
                            <br>
                    ...
                    <h5 class="blue align-center" id="id-company-text">
                    ...
                    <div class="navbar-fixed-top align-right">
                        <br />
                        &nbsp;
                        <a id="btn-login-dark" href="#">Yellow</a>
                        &nbsp;
