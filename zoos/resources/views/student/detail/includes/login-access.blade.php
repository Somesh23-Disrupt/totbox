...
<div class="row">
    ...
    {{--create--}}
    <div class="col-xs-12">
        <h4 class="header large lighter black"><i class="fa fa-key" aria-hidden="true"></i>&nbsp;Create Student Login Access</h4>
    ...
    {{--edit--}}
    <div class="col-xs-12">
        <h4 class="header large lighter black"><i class="fa fa-key" aria-hidden="true"></i>&nbsp;Edit Student Login Access</h4>
...
<div class="row">
    ...
    @if( !$data['guardian_login'])
        {{--create--}}
        <div class="col-xs-12">
            <h4 class="header large lighter black"><i class="fa fa-key" aria-hidden="true"></i>&nbsp;Create Guardian Login Access</h4>
    ...
    @else
        {{--edit--}}
        <div class="col-xs-12">
            <h4 class="header large lighter black"><i class="fa fa-key" aria-hidden="true"></i>&nbsp;Edit Guardian Login Access</h4>
