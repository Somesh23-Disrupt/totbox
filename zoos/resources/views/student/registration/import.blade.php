                        ...
                        <div class="form-horizontal">
                            {!! Form::open(['route' => $base_route.'.bulk.import', 'method' => 'POST', 'class' => 'form-horizontal',
                             'id' => 'validation-form', "enctype" => "multipart/form-data"]) !!}
                                <hr>
                                <a href="{{ asset('assets/csv-template/student-import.xlsx') }}" target="_blank" class="easy-link-menu"><h3><i class="fa fa-download"></i> Click here to Import Student Data</h3></a>
                                <hr>
