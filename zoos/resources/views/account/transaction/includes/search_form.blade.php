    ...
    <div class="panel panel-default">
        ...
        <div class="panel-collapse collapse" id="collapseOne" aria-expanded="false" style="height: 0px;">
            <div class="panel-body">
                ...
                <div class="clearfix">
                    <label class="col-sm-2 control-label">Ledger/Transaction Head</label>
                    <div class="col-sm-5">
                        <select name="tr_head" class="chosen-select form-control" id="form-field-select-3" data-placeholder="Choose a Ledger/Transaction Head..." >
                            <option value="">  </option>
