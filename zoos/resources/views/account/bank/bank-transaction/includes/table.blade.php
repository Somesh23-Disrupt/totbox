        ...
        <div class="table-responsive">
            ...
            <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                ...
                <tr>
                    ...
                    <th class="text-center">Deposit/Withdraw ID</th>
                ...
                <tr style="font-size: 14px; background: orangered;color: white;">
                    ...
                    <td  class="align-right">{{ $drTotal = $data['transaction']->sum('dr_amt') }}</td>
                    <td  class="align-right">{{ $crTotal = $data['transaction']->sum('cr_amt') }}</td>
                    <td  class="align-right">{{ $drTotal - $crTotal }}</td>
                    {{--<td  class="align-right">{{ $data['transaction']->sum('amount') }}</td>--}}
