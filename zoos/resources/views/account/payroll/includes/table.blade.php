<div class="row">
    <div class="col-xs-12">
        <h4 class="header large lighter black"><i class="fa fa-list" aria-hidden="true"></i> Salary Paid History </h4>
        <div class="clearfix">
            ...
            <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                    ...
                    <tfoot>
                        <tr style="font-size: 14px; background: orangered;color: white;">
                            ...
                            <td  class="align-right">{{ $data['salaryPay']->sum('paid_amount') }}</td>
                            <td> </td>
                            <td> </td>
                            <td> </td>
                        </tr>
