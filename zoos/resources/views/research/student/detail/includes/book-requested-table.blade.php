<div class="row">
    <div class="col-xs-12">
        <h4 class="header large lighter black"><i class="fa fa-list" aria-hidden="true"></i> Requested Book List</h4>
        <div class="clearfix">
                        ...
                        <tr>
                            ...
                            <td>
                                @if($requestedBook->image)
                                    <img src="{{ asset('images'.DIRECTORY_SEPARATOR.'manage'.DIRECTORY_SEPARATOR.$requestedBook->image) }}"
                            ...
                            <td>
                                <div class="hidden-sm hidden-xs action-buttons">
                                    ...
                                    <a href="{{ route('research.request-cancel', ['id' => encrypt($requestedBook->id),'member' => encrypt($data['student']->id)]) }}" class="btn btn-danger btn-minier">
