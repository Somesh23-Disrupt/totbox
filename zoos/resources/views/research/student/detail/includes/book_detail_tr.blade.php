    ...
    <td>
        ...
        <div class="col-xs-12 col-sm-3 center">
           <span class="profile-picture">
                @if($books->image != '')
                   <img id="avatar" class="editable img-responsive" alt="{{ $books->title }}" src="{{ asset('images'.DIRECTORY_SEPARATOR.'manage'.DIRECTORY_SEPARATOR.$books->image) }}" />
               @else
                   <img id="avatar" class="editable img-responsive" alt="{{ $books->title }}" src="{{ asset('assets/images/avatars/profile-pic.jpg') }}" />
               @endif
