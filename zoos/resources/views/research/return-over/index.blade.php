        ...
        <div class="main-content-inner">
            <div class="page-content">
                ...
                <div class="page-header">
                    <h1>
                        @include('research.return-over.includes.breadcrumb-primary')
                        <small>
                                ...
                                <div class="tabbable  ">
                                    ...
                                    <div class="tab-content no-border padding-24">
                                        <div id="student" class="tab-pane active">
                                            @include('research.return-over.includes.student')
                                        </div><!-- /#home -->

                                        <div id="staff" class="tab-pane">
                                            @include('research.return-over.includes.staff')
                                        </div><!-- /#home -->
                                    </div>
                                </div>
                            </div>
        ...
        $(document).ready(function () {
            ...
            $('.message-send-btn').click(function () {
                ...
                if($student || $staff){
                    ...
                    bootbox.confirm("Are you sure, You Want Send Research Clearance Message?", function(result) {
                        if(result) {
