<div class="row">
    <div class="col-xs-12">
        <h4 class="header large lighter black"><i class="fa fa-list" aria-hidden="true"></i>&nbsp;Book Taken History List</h4>
        <div class="clearfix">
            <span class="pull-right tableTools-container"></span>
        </div>
        {{--<div class="table-header">
            Chemical Taken History List Record list on table. Filter list using the search box as you wish.
        </div>--}}
                        ...
                        <tr>
                            ...
                            <td>
                                @if($books_history->image)
                                    <img id="avatar" class="editable img-responsive" alt="{{ $books_history->title }}" src="{{ asset('images'.DIRECTORY_SEPARATOR.'manage'.DIRECTORY_SEPARATOR.$books_history->image) }}" style="width: 35px;" />
                                @endif
                            </td>
