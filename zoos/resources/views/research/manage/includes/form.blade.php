<h4 class="header large lighter black">
    <span class="align-left col-md-10">
        <i class="fa fa-plus" aria-hidden="true"></i>&nbsp;Books
    </span>
    <span class="align-right">
        <a class="btn-success btn-sm" href="{{ route('research.manage.import') }}"><i class="fa fa-upload" aria-hidden="true"></i> Bulk Import From CSV</a>
    </span>
</h4>
...
<div class="form-group">
    @if(!isset($data['row']))
        {!! Form::label('research_status', 'Books Status', ['class' => 'col-sm-2 control-label']) !!}
        <div class="col-sm-2">
            {!! Form::select('research_status', $data['research_status'], null, ['class' => 'form-control', "required"]) !!}
            @include('includes.form_fields_validation_message', ['name' => 'research_status'])
        </div>
    @endif
