<h4 class="header large lighter black"><i class="fa fa-list" aria-hidden="true"></i>&nbsp;{{ $panel }} List</h4>
                    ...
                    @if (isset($data['books_collection']) && $data['books_collection']->count() > 0)
                        ...
                        @foreach($data['books_collection'] as $books)
                            <tr>
                                ...
                                <td><div class="label {{ ViewHelper::getBookStatusClassById($books->research_status) }}">{{ ViewHelper::getBookStatusById($books->research_status) }} </div></td>
                                <td class="hidden-480 ">
