    ...
    <div class="col-xs-12 col-sm-3 center">
        <div>
            <span class="profile-picture">
                ...
                @else
                    <img id="avatar" class="editable img-responsive" alt="{{ $data['books']->title }}" src="{{ asset('assets/images/avatars/profile-pic.jpg') }}" />
                @endif
    ...
    <div class="col-xs-12 col-sm-9">
        ...
        <div class="profile-user-info profile-user-info-striped">
            <div class="profile-info-row">
                <div class="profile-info-name"> CAS Number: </div>
                <div class="profile-info-value">
                    <span class="editable" id="reg_no">{{ $data['books']->isbn_number }}</span>
                </div>

                <div class="profile-info-name"> Chemical Code: </div>
                <div class="profile-info-value">
                    <span class="editable" id="reg_no">{{ $data['books']->code }}</span>
                </div>

                <div class="profile-info-name"> Chemical Category: </div>
                <div class="profile-info-value">
            ...
            <div class="profile-info-row">
                ...
                <div class="profile-info-name">Vending Year: </div>
                <div class="profile-info-value">
