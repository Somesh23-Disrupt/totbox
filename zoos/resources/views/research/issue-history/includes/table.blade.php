<div class="row">
    <div class="col-xs-12">
        <h4 class="header large lighter black"><i class="fa fa-list" aria-hidden="true"></i>&nbsp;History List</h4>
        <div class="clearfix">
                ...
                @if (isset($data['history']) && $data['history']->count() > 0)
                    ...
                    @foreach($data['history'] as $history)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('research.book.view', ['id' => $history->book_masters_id]) }}">
                                    {{ $history->title }}
                                </a>
                            </td>
                            <td>
                                <a href="{{ route('research.book') }}?categories={{$history->categories}}">
