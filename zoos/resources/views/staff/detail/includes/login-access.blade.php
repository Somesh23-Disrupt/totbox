...
<div class="row">
    ...
    {{--create--}}
    <div class="col-xs-12">
        <h4 class="header large lighter black"><i class="fa fa-key" aria-hidden="true"></i>&nbsp;Create Staff Login Access</h4>
    ...
    {{--edit--}}
    <div class="col-xs-12">
        <h4 class="header large lighter black"><i class="fa fa-key" aria-hidden="true"></i>&nbsp;Edit Staff Login Access</h4>
