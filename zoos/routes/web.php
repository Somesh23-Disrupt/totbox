...
/*Research Grouping*/
Route::group(['prefix' => 'research/',                                   'as' => 'research.',                                    'namespace' => 'Research\\'], function () {

    Route::get('',                          ['as' => '',                        'middleware' => ['ability:super-admin,research-index'],           'uses' => 'ResearchBaseController@index']);
    Route::post('issue',                    ['as' => 'issue',                   'middleware' => ['ability:super-admin,research-book-issue'],      'uses' => 'ResearchBaseController@issueBook']);

    Route::get('{id}/{member}/request-cancel',       ['as' => 'request-cancel',     'uses' => 'ResearchBaseController@bookRequestCancel']);

    Route::get('{id}/return',               ['as' => 'return',                  'middleware' => ['ability:super-admin,research-book-return'],     'uses' => 'ResearchBaseController@returnBook']);
    Route::get('return-over',               ['as' => 'return-over',             'middleware' => ['ability:super-admin,research-return-over'],     'uses' => 'ResearchBaseController@returnOver']);
    Route::get('issue-history',             ['as' => 'issue-history',           'middleware' => ['ability:super-admin,research-issue-history'],   'uses' => 'ResearchBaseController@issueHistory']);
    Route::post('book-detail-html',         ['as' => 'book-detail-html',                                                                         'uses' => 'ResearchBaseController@bookDetail']);
    Route::get('book-name-autocomplete',    ['as' => 'book-name-autocomplete',                                                                   'uses' => 'ResearchBaseController@bookNameAutocomplete']);

    /*Book Master*/
    Route::get('manage',                          ['as' => 'manage',                'middleware' => ['ability:super-admin,manage-index'],         'uses' => 'ResearchController@index']);
    Route::get('manage/add',                      ['as' => 'manage.add',            'middleware' => ['ability:super-admin,manage-add'],           'uses' => 'ResearchController@add']);
    Route::post('manage/store',                   ['as' => 'manage.store',          'middleware' => ['ability:super-admin,manage-add'],           'uses' => 'ResearchController@store']);
    Route::get('manage/{id}/edit',                ['as' => 'manage.edit',           'middleware' => ['ability:super-admin,manage-edit'],          'uses' => 'ResearchController@edit']);
    Route::post('manage/{id}/update',             ['as' => 'manage.update',         'middleware' => ['ability:super-admin,manage-edit'],          'uses' => 'ResearchController@update']);

    Route::get('manage/import',                      ['as' => 'manage.import',            'middleware' => ['ability:super-admin,manage-add'],           'uses' => 'ResearchController@importBook']);
    Route::post('manage/import',                     ['as' => 'manage.bulk.import',        'middleware' => ['ability:super-admin,manage-add'],             'uses' => 'ResearchController@handleImportBook']);


    Route::get('manage/{id}/view',                ['as' => 'manage.view',           'middleware' => ['ability:super-admin,manage-view'],          'uses' => 'ResearchController@view']);
    Route::get('manage/{id}/delete',              ['as' => 'manage.delete',         'middleware' => ['ability:super-admin,manage-delete'],        'uses' => 'ResearchController@delete']);
    Route::get('manage/{id}/active',              ['as' => 'manage.active',         'middleware' => ['ability:super-admin,manage-active'],        'uses' => 'ResearchController@Active']);
    Route::get('manage/{id}/in-active',           ['as' => 'manage.in-active',      'middleware' => ['ability:super-admin,manage-in-active'],     'uses' => 'ResearchController@inActive']);
    Route::post('manage/bulk-action',             ['as' => 'manage.bulk-action',    'middleware' => ['ability:super-admin,manage-bulk-action'],   'uses' => 'ResearchController@bulkAction']);

    /*Book Level*/
    Route::post('manage/add/copies',                  ['as' => 'manage.add.copies',             'middleware' => ['ability:super-admin,manage-add-copies'],              'uses' => 'ResearchController@addCopies']);
    Route::get('manage/{id}/book-status/{status}',    ['as' => 'manage.book-status',            'middleware' => ['ability:super-admin,manage-status'],                  'uses' => 'ResearchController@bookStatus']);
    Route::post('manage/bulk-copies-delete',          ['as' => 'manage.bulk-copies-delete',     'middleware' => ['ability:super-admin,manage-bulk-copies-delete'],      'uses' => 'ResearchController@bulkCopiesDelete']);

    /*Books Category Routes*/
    Route::get('manage/category',                     ['as' => 'manage.category',               'middleware' => ['ability:super-admin,manage-category-index'],            'uses' => 'ResearchCategoryController@index']);
    Route::post('manage/category/store',              ['as' => 'manage.category.store',         'middleware' => ['ability:super-admin,manage-category-add'],              'uses' => 'ResearchCategoryController@store']);
    Route::get('manage/category/{id}/edit',           ['as' => 'manage.category.edit',          'middleware' => ['ability:super-admin,manage-category-edit'],             'uses' => 'ResearchCategoryController@edit']);
    Route::post('manage/category/{id}/update',        ['as' => 'manage.category.update',        'middleware' => ['ability:super-admin,manage-category-edit'],             'uses' => 'ResearchCategoryController@update']);
    Route::get('manage/category/{id}/delete',         ['as' => 'manage.category.delete',        'middleware' => ['ability:super-admin,manage-category-delete'],           'uses' => 'ResearchCategoryController@delete']);
    Route::get('manage/category/{id}/active',         ['as' => 'manage.category.active',        'middleware' => ['ability:super-admin,manage-category-active'],           'uses' => 'ResearchCategoryController@Active']);
    Route::get('manage/category/{id}/in-active',      ['as' => 'manage.category.in-active',     'middleware' => ['ability:super-admin,manage-category-in-active'],        'uses' => 'ResearchCategoryController@inActive']);
    Route::post('manage/category/bulk-action',        ['as' => 'manage.category.bulk-action',   'middleware' => ['ability:super-admin,manage-category-bulk-action'],      'uses' => 'ResearchCategoryController@bulkAction']);

    /*Books Category Routes*/
    Route::get('circulation',                       ['as' => 'circulation',                 'middleware' => ['ability:super-admin,research-circulation-index'],          'uses' => 'CirculationController@index']);
    Route::post('circulation/store',                ['as' => 'circulation.store',           'middleware' => ['ability:super-admin,research-circulation-add'],            'uses' => 'CirculationController@store']);
    Route::get('circulation/{id}/edit',             ['as' => 'circulation.edit',            'middleware' => ['ability:super-admin,research-circulation-edit'],           'uses' => 'CirculationController@edit']);
    Route::post('circulation/{id}/update',          ['as' => 'circulation.update',          'middleware' => ['ability:super-admin,research-circulation-edit'],           'uses' => 'CirculationController@update']);
    Route::get('circulation/{id}/delete',           ['as' => 'circulation.delete',          'middleware' => ['ability:super-admin,research-circulation-delete'],         'uses' => 'CirculationController@delete']);
    Route::get('circulation/{id}/active',           ['as' => 'circulation.active',          'middleware' => ['ability:super-admin,research-circulation-active'],         'uses' => 'CirculationController@Active']);
    Route::get('circulation/{id}/in-active',        ['as' => 'circulation.in-active',       'middleware' => ['ability:super-admin,research-circulation-in-active'],      'uses' => 'CirculationController@inActive']);
    Route::post('circulation/bulk-action',          ['as' => 'circulation.bulk-action',     'middleware' => ['ability:super-admin,research-circulation-bulk-action'],    'uses' => 'CirculationController@bulkAction']);

    /*Library Member Routes*/
    Route::get('member',                        ['as' => 'member',              'middleware' => ['ability:super-admin,research-member-index'],           'uses' => 'MemberController@index']);
    Route::get('member/add',                    ['as' => 'member.add',          'middleware' => ['ability:super-admin,research-member-add'],             'uses' => 'MemberController@add']);
    Route::post('member/store',                 ['as' => 'member.store',        'middleware' => ['ability:super-admin,research-member-add'],             'uses' => 'MemberController@store']);
    Route::get('member/quick-membership',  ['as' => 'member.quick-membership',         'middleware' => ['ability:super-admin,research-member-add'],            'uses' => 'MemberController@quickMembership']);
    Route::get('member/{id}/edit',              ['as' => 'member.edit',         'middleware' => ['ability:super-admin,research-member-edit'],            'uses' => 'MemberController@edit']);
    Route::post('member/{id}/update',           ['as' => 'member.update',       'middleware' => ['ability:super-admin,research-member-edit'],            'uses' => 'MemberController@update']);
    Route::get('member/{id}/delete',            ['as' => 'member.delete',       'middleware' => ['ability:super-admin,research-member-delete'],          'uses' => 'MemberController@delete']);
    Route::get('member/{id}/active',            ['as' => 'member.active',       'middleware' => ['ability:super-admin,research-member-active'],          'uses' => 'MemberController@Active']);
    Route::get('member/{id}/in-active',         ['as' => 'member.in-active',    'middleware' => ['ability:super-admin,research-member-in-active'],       'uses' => 'MemberController@inActive']);
    Route::post('member/bulk-action',           ['as' => 'member.bulk-action',  'middleware' => ['ability:super-admin,research-member-bulk-action'],     'uses' => 'MemberController@bulkAction']);

    /*Library Member Staff Routes*/
    /*Staff Member*/
    Route::get('staff',                 ['as' => 'staff',                   'middleware' => ['ability:super-admin,research-member-staff'],      'uses' => 'StaffMemberController@staff']);
    Route::get('staff/{id}/view',       ['as' => 'staff.view',              'middleware' => ['ability:super-admin,research-member-staff-view'],      'uses' => 'StaffMemberController@staffView']);

    /*Student Member*/
    Route::get('student',                   ['as' => 'student',                 'middleware' => ['ability:super-admin,research-member-student'],      'uses' => 'StudentMemberController@student']);
    Route::get('student/{id}/view',         ['as' => 'student.view',            'middleware' => ['ability:super-admin,research-member-student-view'],      'uses' => 'StudentMemberController@studentView']);
