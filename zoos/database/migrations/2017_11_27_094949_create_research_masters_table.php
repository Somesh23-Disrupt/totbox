...
class CreateResearchMastersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('research_masters', function (Blueprint $table) {
            $table->increments('id');
            $table->timestamps();
            ...
            $table->foreign('categories')->references('id')->on('research_categories');
        });
    }
    ...
    {
        Schema::dropIfExists('research_masters');
    }
}
