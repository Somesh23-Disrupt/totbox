...
class CreateResearchCirculationsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('research_circulations', function (Blueprint $table) {
            $table->increments('id');
            $table->timestamps();
    ...
    {
        Schema::dropIfExists('research_circulations');
    }
}
